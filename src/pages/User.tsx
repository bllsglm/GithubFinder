          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions">
                <a href={html_url} target='_blank' rel='noreferer' className='btn btn-outline'>
              ...
              {location && (
               ...
               {blog && (
                <div className='stat'>
                  ...
                  <a href={blog} target='_blank' rel='noreferer'>{blog}</a>
                </div>
              )}
                {twitter_username && (
              <div className='stat'>
                <div className="stat-title text-md">Twitter</div>
                <a href={`https://twitter.com/${twitter_username}`} target='_blank' rel='noreferer'>{twitter_username}</a>
              </div>
              )}
            </div>
          </div>
